...
{
    [TestClass]
    public class Test9 : NetworkCardSpeedTestFlow
    {
        public const string Name = "Test9";
        public const string Description = "Test with card mode 9";
        ...
        {
            Console.WriteLine("Executing test for mode 9");
        ...
        public override bool Clean()
        {
            RestoreDefaultMode();
            RestoreDefaultSpeed();
            Console.WriteLine("\nCleaning up after test for mode 9");
            return true;
        }
    }
}
