...
{
    [TestClass]
    public class Test5 : NetworkCardSpeedTestFlow
    {
        public const string Name = "Test5";
        public const string Description = "Test with card mode 5";
        ...
        {
            Console.WriteLine("Executing test for mode 5");
        ...
        public override bool Clean()
        {
            RestoreDefaultMode();
            RestoreDefaultSpeed();
            Console.WriteLine("\nCleaning up after test for mode 5");
            return true;
        }
    }
}
