...
{
    [TestClass]
    public class Test10 : NetworkCardSpeedTestFlow
    {
        public const string Name = "Test10";
        public const string Description = "Test with card mode 10";
        ...
        {
            Console.WriteLine("Executing test for mode 10");
        ...
        public override bool Clean()
        {
            RestoreDefaultMode();
            RestoreDefaultSpeed();
            Console.WriteLine("\nCleaning up after test for mode 10");
            return true;
        }
    }
}
